...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Undangan tematic</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="meINVITEyou.com" />
	<meta name="keywords" content="meinviteyou" />
	<meta name="author" content="meINVITEyou.com" />
  ...
  <!-- 
	...
	<style>
      .simply-countdown > .simply-section {
		  ...
		  width: 100px;
		  height: 100px;
		  /*background: rgba(36, 132, 166, 0.9);*/
			...
			<div class="row">
				<div class="col-xs-9 col-sm-4 col-md-4 col-lg-3">
					<div id="fh5co-logo">
						...
						<strong style="margin-left:30px;">Romeo & Juliete</strong>
					</a>
					</div>
				</div>
				<div class="col-xs-3 col-sm-8 col-md-8 col-lg-9 text-right menu-1">
					<ul>
						<li><a class="js-gotop" href="#"></i><i class="text-danger fas fa-home" style="font-size:25px;margin:10px 0 10px 0;"></i> Home</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h2 style="color:#2484a6;">Hello!</h2>
					<h3>Mr.Bill Gates</h3>
					<p data-aos="zoom-in-down" data-aos-duration="1000">Atas nama Allah SWT yang Maha Penyayang dan Maha Penyayang, dengan senang hati kami berbagi kegembiraan di pesta pernikahan kami.</p>
				</div>
			</div>
			<div class="couple-wrap" id="mempelai">
				<!-- <div style="background-color:red!important"> -->
				<div class="couple-half" data-aos="fade-right" data-aos-duration="1000" style="background-color:#2484a6!important;border-radius:10px;margin-top:10px;padding:10px 0 10px 0;">
					<div class="groom" style="display:flex;justify-content:center;">
						<img src="<?=base_url('assets/img/contoh/mpria.jpg'); ?>" alt="groom" class="img-responsive img-thumbnail">
					</div>
					<div class="desc-groom">
						<h3 style="margin-bottom:5px;color:white;font-size:40px;">Romeo Aguero</h3>
						<!-- <span>Putra dari:</span> -->
						<p style="margin-top:-5px;color:#ddd;">Putra pertama dari:<br>Bapak Romeo & Ibu Romeo</p>
					</div>
				</div>
				<p class="heart text-center"><i class="icon-heart2"></i></p>
				<div class="couple-half" data-aos="fade-left" data-aos-duration="1000" style="background-color:#2484a6!important;border-radius:10px;margin-top:10px;padding:10px 0 10px 0;">
					<div class="bride" style="display:flex;justify-content:center;">
						<img src="<?=base_url('assets/img/contoh/mwanita.jpg'); ?>" alt="groom" class="img-responsive img-thumbnail">
					</div>
					<div class="desc-bride">
						<h3 style="margin-bottom:5px;color:white;font-size:40px;">Juliete Roulete</h3>
						<!-- <span>Putri dari:</span> -->
						<p style="margin-top:-5px;color:#ddd;">Putri kedua dari:<br>Bapak Juliete & Ibu Juliete</p>
					</div>
				</div>
				<!-- </div> -->
			</div>
	...
	<div id="fh5co-event" class="fh5co-bg" style="background-color:#2484a6;">
		<div class="overlay"></div>
							...
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap" data-aos="zoom-in-up" data-aos-duration="1000">
									...
									<div class="event-col">
										...
										<span>07.00 s/d Selesai</span>
										<!-- <span>6:00 PM</span> -->
									</div>
									<div class="event-col">
										<i class="icon-calendar"></i>
										<span>17 agustus 2021</span>
										<!-- <span>November, 2016</span> -->
									</div>
									<p><d style="font-weight:bold;">Alamat</d><br>Lapanagan umum SP2 mulyasari</p>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap" data-aos="zoom-in-up" data-aos-duration="1000">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<!-- <h2>Our Story</h2> -->
					<p data-aos="fade-up" data-aos-duration="1000">Sungguh suatu kehormatan dan kebahagiaan bagi kami, apabila Bapak/Ibu/Saudara/I berkenan hadir untuk memberikan Do'a restunya kami sekeluarga mengucapkan terima kasih</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container" id="galerisa">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<h2 style="color:#2484a6;">Foto Galeri</h2>
			...
			<div class="row row-bottom-padded-md">
				<div class="col-md-12">
					...
					<li class="one-third" data-aos="zoom-in" data-aos-duration="1000" data-animate-effect="fadeIn" style="background-image: url('<?=base_url('assets/img/contoh/galeris.jpg'); ?>'); "> 
						<a href="<?=base_url('assets/img/contoh/galeris.jpg'); ?>">
			...
			<div class="row">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
						...
						<h2 style="color:#2484a6;">Ucapatan Teman</h2>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 animate-box">
						<div class="wrap-testimony">
							<div class="owl-carousel-fullwidth titems">
								...
								<div class="itemsss" style="background-color:rgba(152, 250, 242,.3);border-radius:10px;margin-bottom:-20px">
									<div class="testimony-slide active text-center" style="padding-top:10px;">
										<span style="font-size:13px;">Mr.Bill Gates</span>
								...
								<div class="itemsss" style="background-color:rgba(152, 250, 242,.3);border-radius:10px;margin-bottom:-20px">
									<div class="testimony-slide active text-center">
										<span style="font-size:13px;">Steven</span>
										<blockquote style="margin-top:-10px">
											<p style="font-style:initial;font-size:17px">
												"HWD!"
											</p>
								...
								<div class="itemsss" style="background-color:rgba(152, 250, 242,.3);border-radius:10px;margin-bottom:-20px">
									<div class="testimony-slide active text-center">
										<span style="font-size:13px;">Arsi</span>
										<blockquote style="margin-top:-10px">
											<p style="font-style:initial;font-size:17px">
												"Selamat ya!"
											</p>
								...
								<div class="itemsss" style="background-color:rgba(152, 250, 242,.3);border-radius:10px;margin-bottom:-20px">
									<div class="testimony-slide active text-center">
										<span style="font-size:13px;">Roman</span>
										<blockquote style="margin-top:-10px">
											<p style="font-style:initial;font-size:17px">
												"H.W.D!"
											</p>
								...
								<div class="itemsss">
									<div class="testimony-slide active text-center">
										<blockquote>
											<p style="font-style:initial;font-size:19px;line-height:20px">Romeo & Juliete <br> Terima kasih atas ucapan & doa nya</p>
										</blockquote>
									</div>
								</div>
			...
			<div class="row animate-box">
				<div class="col-md-10 col-md-offset-1">
					<form class="form-inline" method="post" action="">
						...
						<div class="col-md-4 col-sm-4">
							<button style="background-color:#2484a6;margin-top:30px" type="submit" class="btn btn-default btn-block" name="kirimin">Kirim</button>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					...
					<span style="font-size:22px;font-weight:bold;">Romeo & Juliete</span>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center" style="background-image:url('<?=base_url('assets/img/flowersbg/back3rustic.jpg') ?>');background-size:110%;background-repeat:repeat;text-align:center;">
            ...
            <span>Hello,</span><br>
            <span style="font-size:20px;margin-top:-10px">Mr.Bill Gates</span><br>
