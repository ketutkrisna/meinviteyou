...
<html lang="en">
  ...
  <body id="home">
    ...
    <div class="profilemempelai" style="min-height:500px;background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/body-bg.png');padding-bottom:70px;">
      ...
      <div class="container">
        <div class="text-center" data-aos="zoom-in" data-aos-duration="1000" style="font-family: 'Comfortaa', cursive;padding:15px;color:#a1a1a1;">
          Mahasuci Tuhan telah menciptakan manusia dengan berpasang-pasangan. Sungguh besar rahmat dan karunia yang diberikan-Nya kepada keluarga Kami. Maka izinkan Kami mengundang sekaligus mengharapkan doa restu dari bapak/ibu dalam acara pertunangan putra & putri kami.
        </div>
      </div>
      <div class="container">
      <div class="row mt-3">
          ...
          <div class="col-12 text-center mt-3">
            <div class="d-flex justify-content-center">
              <div class="hari" data-aos="zoom-in" data-aos-duration="1000" style="background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/countdown.png');height:200px;width:200px;background-size:cover;">
                ...
                <div style="font-size:25px;font-family: 'Comfortaa', cursive;color:white;">Selasa, 17 Agustus 1945</div>
              </div>
            </div>
