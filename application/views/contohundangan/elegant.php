...
<html lang="en">
  <head>
    <title>Engagement Elegant</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body id="home">
    <div class="headerawal" style="background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/lp.jpg');background-size:cover;height:550px;background-position:center;">
      <div class="headernama text-center" data-aos="fade-down" data-aos-duration="1000" style="position:relative;background-color:rgba(255,255,255,.2);">
        <div class="dan" style="font-family: 'Tangerine', cursive;font-size:45px;font-weight:bold;color:#00E0D6;text-shadow:1px 1px 3px grey;padding-bottom:5px;">Romeo & Juliete</div>
      </div>
      <div class="bgkus d-flex justify-content-center" data-aos="zoom-in" data-aos-duration="1000">
        <div class="std text-center" style="position:relative;background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/splash-bg.png');width:350px;height:350px;background-size:cover;margin-top:40px">
          ...
          <h4 class="text-center" style="font-family: 'Comfortaa', cursive;margin-top:160px;font-size:30px;font-weight:bold;color:#00E0D6;text-shadow:1px 1px 3px grey;">17 Agustus 1945</h4>
    ...
    <div class="profilemempelai" style="min-height:500px;background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/body-bg.png');padding-bottom:70px;">
      ...
      <div class="container">
        <div class="text-center" data-aos="zoom-in" data-aos-duration="1000" style="font-family: 'Comfortaa', cursive;padding:15px;color:#a1a1a1;font-style:italic;">
          Mahasuci Tuhan telah menciptakan manusia dengan berpasang-pasangan. Sungguh besar rahmat dan karunia yang diberikan-Nya kepada keluarga Kami. Maka izinkan Kami mengundang sekaligus mengharapkan doa restu dari bapak/ibu dalam acara pernikahan putra & putri kami.
        </div>
      </div>
      <div class="container">
      <div class="row mt-3">
        <div class="col-12 col-lg-4 mt-5">
          <div class="m1 d-flex justify-content-center">
            <div class="mp" data-aos="fade-down" data-aos-duration="1000" style="height:120px;width:120px;box-shadow:6px 6px 1px #00E0D6;border-radius:20px;">
              <img src="<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/mpria.jpg" style="width:100%;height:100%;border-radius:20px;">
            </div>
          </div>
          <div class="desk text-center" data-aos="fade-up" data-aos-duration="1000" style="font-family: 'Comfortaa', cursive;">
            <div class="mt-1" style="color:#00E0D6;font-size:20px">Romeo Aguero</div>
            <div style="color:#bbb;">Putra pertama dari</div>
            <div style="color:#a6a6a6;">(Bapak Aguero & Ibu Aguero)</div>
          </div>
        </div>
        <div class="col-12 col-lg-4 mt-5">
        ...
        <div class="col-12 col-lg-4 mt-5">
          <div class="m1 d-flex justify-content-center">
            <div class="mp" data-aos="fade-down" data-aos-duration="1000" style="height:120px;width:120px;box-shadow:6px 6px 1px #00E0D6;border-radius:20px;">
              <img src="<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/mwanita.jpg" style="width:100%;height:100%;border-radius:20px;">
            </div>
          </div>
          <div class="desk text-center" data-aos="fade-up" data-aos-duration="1000" style="font-family: 'Comfortaa', cursive;">
            <div class="mt-1" style="color:#00E0D6;font-size:20px">Juliete Batista</div>
            <div style="color:#bbb;">Putri pertama dari</div>
            <div style="color:#a6a6a6;">(Bapak Juliete & Ibu Juliete)</div>
          </div>
        </div>
      </div>
      </div>
    ...
    <div class="acara" style="min-height:500px;background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/sectionright.png');background-position:right -30px;background-size:300px;background-repeat:no-repeat;padding-bottom:50px;">
          ...
          <div class="col-12 text-center mt-3">
            <div class="d-flex justify-content-center">
              <div class="hari" data-aos="zoom-in" data-aos-duration="1000" style="background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/countdown.png');height:200px;width:200px;background-size:cover;">
                ...
                <div style="font-size:22px;font-family: 'Comfortaa', cursive;color:white;font-style: italic;">Selasa, 17 Agustus 1945</div>
              </div>
            </div>
            <div class="jam mt-1" data-aos="fade-up" data-aos-duration="1000" style="color:#a1a1a1;font-size:18px;"><i class="far fa-clock"></i> Pukul 10.00 - SELESAI</div>
            <div class="alamat mt-1" data-aos="fade-up" data-aos-duration="1000" style="color:#a1a1a1;font-size:18px;"><i class="fas fa-map-marker-alt"></i> Jalan cinta menuju kebahagiaan No.1</div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container mt-3">
        <div class="text-center" data-aos="zoom-in" data-aos-duration="1000" style="font-family: 'Comfortaa', cursive;padding:15px;color:#a1a1a1;font-style:italic;">
          Sungguh suatu kehormatan dan kebahagiaan bagi kami, apabila Bapak/Ibu/Saudara/I berkenan hadir untuk memberikan Do'a restunya kami sekeluarga mengucapkan terima kasih
        </div>
      </div>
    ...
    <div class="rsvp" style="min-height:500px;background-image:url('<?=base_url('assets/temaundangan/engagement/elegant/'); ?>img/sectionright.png');padding-bottom:70px;background-size:cover;background-attachment: fixed;">
      ...
      <div class="row">
        <div class="col-12 mt-3 mb-3 text-center text-light">
          <span style="font-size:25px;font-weight:500;font-family: 'Comfortaa', cursive;color:#a1a1a1">Romeo & Juliete</span><br>
      ...
      <div class="modal-dialog modal-fullscreen">
        <div class="modal-content text-center text-light" style="background-color:rgba(0,0,0,.8);">
          <div class="modal-header d-flex justify-content-center">
            <h5 class="modal-title" id="staticBackdropLabel" style="font-family: 'Tangerine', cursive;font-size:45px;">Romeo & Juliete</h5>
          </div>
          <div class="modal-body">
            <div class="row">
              <h5>Hello,</h5>
              <h3 style="font-family: 'Comfortaa', cursive;font-weight:bold;">Mr. Bill Gates</h3>
