...
<body id="home">
    ...
    <section id="portfolio" class="section-bg">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-3 col-md-4 col-6 portfolio-item filter-app">
          <div class="portfolio-wrap text-center">
            ...
            <div class="portfolio-info">
              <h4><a href="#!" style="color:#616161;">ELEGANT</a></h4>
              <p>Pernikahan</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-6 portfolio-item filter-app">
          <div class="portfolio-wrap text-center">
            <figure>
              <img src="<?=base_url('/'); ?>assets/img/portfolio/desain-minimalis.jpg" class="img-fluid" alt="tema minimalis">
              <a href="<?=base_url('/'); ?>assets/img/portfolio/desain-minimalis.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Design Minimalis"><i class="ion ion-eye"></i></a>
              <a target="_blank" href="<?=base_url('/'); ?>contohundangan/minimalis/" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="#!" style="color:#616161;">MINIMALIS</a></h4>
              <p>Pernikahan</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-6 portfolio-item filter-app">
          <div class="portfolio-wrap text-center">
            <figure>
              <img src="<?=base_url('/'); ?>assets/img/portfolio/desain-classic.jpg" class="img-fluid" alt="tema classic">
              <a href="<?=base_url('/'); ?>assets/img/portfolio/desain-classic.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Design Classic"><i class="ion ion-eye"></i></a>
        ...
        <div class="col-lg-3 col-md-4 col-6 portfolio-item filter-app">
          <div class="portfolio-wrap text-center">
            <figure>
              <img src="<?=base_url('/'); ?>assets/img/portfolio/desain-vantage.jpg" class="img-fluid" alt="">
              <a href="<?=base_url('/'); ?>assets/img/portfolio/desain-vantage.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Design Vantage"><i class="ion ion-eye"></i></a>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Indonesia <br>
              <strong>Phone:</strong> 082179471533<br>
              <strong>Email:</strong> ketutkrisna21@gmail.com<br>
            </p>
  ...
  <a href="#" style="bottom:35px" class="back-to-top"><i class="fa fa-chevron-up"></i></a>
